...
/// The initial fat-pointer stage only generates typedef declarations and role-specific renderers;
/// ordinary object storage keeps the legacy raw pointer until the representation cutover.
