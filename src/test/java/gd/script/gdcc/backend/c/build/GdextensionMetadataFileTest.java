...
class GdextensionMetadataFileTest {
    ...
    void renderMultiPlatformEmitsArchQualifiedKeysWithCompatibilityAliases() {
        ...
        libraryPathByPlatform.put(TargetPlatform.MACOS_AARCH64, "res://addons/gdcc/bin/libgdcc_for_editor_debug_aarch64.dylib");
        ...
        assertEquals("""
                ...
                macos.debug.arm64 = "res://addons/gdcc/bin/libgdcc_for_editor_debug_aarch64.dylib"
                macos.release.arm64 = "res://addons/gdcc/bin/libgdcc_for_editor_debug_aarch64.dylib"
                """, rendered);
    }
    ...
    void archQualifiedLibraryKeyCoversEveryPlatformWithGodotArchNames() {
        ...
        expectedKeys.put(TargetPlatform.MACOS_X86_64, "macos.debug.x86_64");
        expectedKeys.put(TargetPlatform.MACOS_AARCH64, "macos.debug.arm64");
