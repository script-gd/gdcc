class_name BenchmarkSeriesRecurrence
extends Node

var _geometric_start: float = 0.0
var _ratio: float = 0.0
var _fib_steps: int = 0
var _alternating_steps: int = 0
var _alternating_seed: int = 0
var _alternating_step: int = 0
...
func benchmark() -> float:
    var geometric_sum: float = 0.0
    var geometric_term: float = _geometric_start
    var geometric_index: int = 0
    ...
    var fib_previous: float = 1.0
    var fib_current: float = 1.0
    var fib_index: int = 0
    while fib_index < _fib_steps:
        var fib_next: float = fib_previous + fib_current
        fib_previous = fib_current
        fib_current = fib_next
        fib_index = fib_index + 1

    var alternating_value: float = 3.0
    var alternating_direction: float = 1.0
    var alternating_index: int = 0
